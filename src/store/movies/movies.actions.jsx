	...
	return (dispatch) => {
		...
		axios
			...
			.then((res) => {
				...
				if (isPage) {
					dispatch(
						fetchAdventureMoviesSuccess(adventureMovies, isPage)
					);
	...
	return (dispatch) => {
		...
		axios
			...
			.then((res) => {
				...
				if (isPage) {
					dispatch(
						fetchAnimationMoviesSuccess(animationMovies, isPage)
					);
	...
	return (dispatch) => {
		...
		axios
			...
			.then((res) => {
				...
				if (isPage) {
					dispatch(
						fetchTopRatedMoviesSuccess(topRatedMovies, isPage)
					);
	...
	return (dispatch) => {
		...
		axios
			...
			.then((res) => {
				...
				if (isPage) {
					dispatch(
						fetchTrendingMoviesSuccess(trendingMovies, isPage)
					);
